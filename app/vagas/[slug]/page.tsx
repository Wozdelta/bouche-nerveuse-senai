...
import {
    ...
    Phone, Star, Share2, Info, ArrowRight, Utensils
} from 'lucide-react';
...
const vagasData = {
    ...
    'aux-de-producao-junior': {
        titulo: 'Auxiliar de Produção Júnior',
        empresa: 'Bouche Nerveuse',
        local: 'Araraquara - SP',
        salario: 'R$ 2.300,00',
        tipo: 'CLT (Efetivo)',
        horario: 'De segunda a sexta, das 07:30 às 13:40',
        vagas: 4,
        descricao: 'Buscamos um Auxiliar de Produção Júnior dinâmico e proativo para integrar nossa equipe. Você será fundamental para garantir que nossa produção flua com qualidade e eficiência.',
        responsabilidades: [
            'Auxiliar nas diferentes etapas da linha de produção.',
            'Manter a organização, higiene e limpeza do ambiente de trabalho.',
            'Apoiar os operadores e a liderança na separação de materiais.',
            'Realizar o empacotamento e inspeção visual dos produtos.',
            'Cumprir os protocolos e normas de segurança do trabalho.'
        ],
        requisitos: [
            'Ensino Médio completo ou cursando.',
            'Estar cursando ou ter concluído curso de Auxiliar de Linha de Produção, Metrologia ou Controle de Qualidade.',
            'Dinamismo, atenção aos detalhes e vontade de aprender.',
            'Capacidade de seguir instruções e trabalhar em equipe.',
            'Disponibilidade de horário.'
        ],
        diferenciais: [
            'Experiência anterior em áreas operacionais ou de produção.',
...
export default function VagaDetalhes() {
    ...
    const handleShare = async () => {
        ...
        const title = `Vaga para ${vaga?.titulo} na ${vaga?.empresa}`;
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap gap-6 text-white/80 text-base lg:text-lg max-w-3xl">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                                    <Utensils size={20} className="text-wine-light" />
                                </div>
                                <span>Vale alimentação e refeição R$ 800</span>
                            </div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="sticky top-28 bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
                            ...
                            <div className="space-y-6 mb-8">
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center shrink-0 border border-gray-100">
                                        <Utensils className="text-wine" size={24} />
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500 font-medium uppercase tracking-wider mb-1">Alimentação e Refeição</p>
                                        <p className="text-brown-dark font-bold">R$ 800,00</p>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <button onClick={handleShare} className="w-full bg-white hover:bg-gray-50 text-brown-dark border border-gray-200 font-bold py-4 px-6 rounded-xl transition-colors flex items-center justify-center gap-2">
                                    <Share2 size={20} />
                                    Compartilhar vaga
                                </button>
                            </div>
